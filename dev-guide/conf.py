...
# sphinx-quickstart on Fri Jun 19 12:44:05 2015.
#
...
html_title = 'Rackspace Cloud Networks version 2.0 API Developer Guide'
...
latex_documents = [
  (master_doc, 'docs-cloud-networks.tex', 'Rackspace Cloud Networks API Developer Guide',
...
texinfo_documents = [
  (master_doc, 'docs-cloud-networks', u'Rackspace Cloud Load Balancers API Developer Guide',
   'Cat Lookabaugh', 'docs-cloud-networks', 'Learn about using the Rackspace Cloud Networks service',
   'Miscellaneous'),
]
