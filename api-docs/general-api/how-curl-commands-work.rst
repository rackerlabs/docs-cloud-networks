...
Mac OS X, and Windows. For information about cURL, see 
...
see :ref:`Export environment variables to run cURL commands<export-environment-variables>`.

.. _generalapi-curl-json:
