...
This operation updates the association of a floating IP address with a port,
either associating or disassociating it.

To disassociate a floating IP address from a port, set the ``port_id``
